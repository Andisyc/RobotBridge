...
# GMT Record mp4 filter trackable motion sequence
...
# GMT Record mp4 single motion sequence
HYDRA_FULL_ERROR=1 MUJOCO_GL=egl PYOPENGL_PLATFORM=egl python robustness_validation/run_validation_mujoco.py \
